...
+ =Ctrl+q= keybinding quits/closes the app.
+ Hyperlinks open in external browser.
...
- [ ] Memory kill switch option.
- [ ] Lower memory usage in Tray/startup.
- [ ] Custom app icon with instant updates. =/usr/share/icons/hicolor/256x256/apps/whatsit_custom.png=
- [ ] Give another url to open it as a webapp.

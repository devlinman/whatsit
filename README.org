...
+ In =v3.0.0=, additional features such as memory kill switch and custom app and tray icons, etc.
...
+ Config file located at =~/.config/whatsit/whatsit.ini=.
...
- [X] Search app menu from titlebar.
